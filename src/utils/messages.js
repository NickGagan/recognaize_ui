...
const RECOGNIZE_AI_MODEL_DESC = `This is a template for our model description. Recognize.ai leverages ______'s model.
Here is a description of how the model works:

The preprocessing steps include: X text preprocessing. Applied X models.

Some other model results included:
